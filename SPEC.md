...
4. El usuario puede eliminar un chat existente desde el mismo menú kebab, con modal de confirmación previo ("¿Eliminar este chat? Esta acción no se puede deshacer")
