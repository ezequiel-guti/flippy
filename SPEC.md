...
9. La navegación por carpetas se hace desde un árbol lateral (sidebar), estilo file manager clásico: expandir/contraer subcarpetas, ver la carpeta actual resaltada; el toggle "ver todo el corpus" muestra el listado sin filtrar por carpeta
